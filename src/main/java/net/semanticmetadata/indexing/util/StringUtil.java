 ...
 * an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. /** <p>Operations on
 * {@link java.lang.String} that are <code>null</code> safe.</p>
 * 
 * <ul> <li><b>IsEmpty/IsBlank</b> - checks if a String contains text</li> <li><b>Trim/Strip</b> - removes leading and
 * trailing whitespace</li> <li><b>Equals</b> - compares two strings null-safe</li>
 ...
 * <li><b>ContainsOnly/ContainsNone</b> - does String contains only/none of these characters</li>
 ...
 * <li><b>Split/Join</b> - splits a String into an array of substrings and vice versa</li> <li><b>Remove/Delete</b> -
 * removes part of a String</li> <li><b>Replace/Overlay</b> - Searches a String and replaces one String with
 * another</li> <li><b>Chomp/Chop</b> - removes the last part of a String</li> <li><b>LeftPad/RightPad/Center/Repeat</b>
 * - pads a String</li> <li><b>UpperCase/LowerCase/SwapCase/Capitalize/Uncapitalize</b> - changes the case of a
 * String</li> <li><b>CountMatches</b> - counts the number of occurrences of one String in another</li>
 * <li><b>IsAlpha/IsNumeric/IsWhitespace/IsAsciiPrintable</b> - checks the characters in a String</li>
 * <li><b>DefaultString</b> - protects against a null input String</li> <li><b>Reverse/ReverseDelimited</b> - reverses a
 * String</li> <li><b>Abbreviate</b> - abbreviates a string using ellipsis</li> <li><b>Difference</b> - compares two
 * Strings and reports on their differences</li> <li><b>LevensteinDistance</b> - the number of changes needed to change
 * one String into another</li> </ul>
 * 
 * <p>The <code>StringUtils</code> class defines certain words related to String handling.</p>
 * 
 * <ul> <li>null - <code>null</code></li> <li>empty - a zero-length string (<code>""</code>)</li> <li>space - the space
 * character (<code>' '</code>, char 32)</li> <li>whitespace - the characters defined by {@link
 * Character#isWhitespace(char)}</li> <li>trim - the characters &lt;= 32 as in {@link String#trim()}</li> </ul>
 * 
 * <p><code>StringUtils</code> handles <code>null</code> input Strings quietly. That is to say that a <code>null</code>
 * input will return <code>null</code>. Where a <code>boolean</code> or <code>int</code> is being returned details vary
 * by method.</p>
 * 
 * <p>A side effect of the <code>null</code> handling is that a <code>NullPointerException</code> should be considered a
 * bug in <code>StringUtils</code> (except for deprecated methods).</p>
 * 
 * <p>Methods in this class give sample code to explain their operation. The symbol <code>*</code> is used to indicate
 * any input including <code>null</code>.</p>
 * 
...
public class StringUtil {
     ...
     * 
     * <p>
     * For a word based algorithm, see {@link WordUtils#swapCase(String)}. A <code>null</code> input String returns
     * <code>null</code>.
     * </p>
     * 
     * <pre>
    ...
    // birden fazla kelimeden olusan stringlerde birden fazla bosluk karakterini bir bosluga indiren ve
    // bastaki ve sondaki bosluklari silen metod
    public static String getCorrectedStrip(String s) {
